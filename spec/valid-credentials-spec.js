...
describe('validCredentials', () => {
	...
	const referenceIdentifiers = {
		...
		referenceUSGovIdentifiers = {
			'root account': 'arn:aws-us-gov:iam:us-gov-west-1:123456789012:root',
			'iam user': 'arn:aws-us-gov:iam:us-gov-west-1:123456789012:user/Bob',
			'subdivision user': 'arn:aws-us-gov:iam:us-gov-west-1:123456789012:user/division_abc/subdivision_xyz/Bob',
			'group': 'arn:aws-us-gov:iam:us-gov-west-1:123456789012:group/Developers',
			'division group': 'arn:aws-us-gov:iam:us-gov-west-1:123456789012:group/division_abc/subdivision_xyz/product_A/Developers',
			'role': 'arn:aws-us-gov:iam:us-gov-west-1:123456789012:role/S3Access',
			'subrole': 'arn:aws-us-gov:iam:us-gov-west-1:123456789012:role/application_abc/component_xyz/S3Access',
			'instance': 'arn:aws-us-gov:iam:us-gov-west-1:123456789012:instance-profile/Webserver',
			'federated user': 'arn:aws-us-gov:sts:us-gov-west-1:123456789012:federated-user/Bob',
			'mfa user': 'arn:aws-us-gov:iam:us-gov-west-1:123456789012:mfa/BobJonesMFA',
			'server-cert': 'arn:aws-us-gov:iam:us-gov-west-1:123456789012:server-certificate/ProdServerCert',
			'server-division-cert': 'arn:aws-us-gov:iam:us-gov-west-1:123456789012:server-certificate/division_abc/subdivision_xyz/ProdServerCert'
		};
	...
	Object.keys(referenceUSGovIdentifiers).forEach(key => {
		it('recognises partition ' + key, () => {
			expect(validCredentials(referenceUSGovIdentifiers[key])).toBeTruthy();
		});
	});
